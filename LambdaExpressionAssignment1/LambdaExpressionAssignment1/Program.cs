...
namespace LambdaExpressionAssignment1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //At laest two employees should have the first name "Joe"
            List<Employee> campus = new List<Employee>()
            {
                ...
                new Employee() { Id = 3, firstName = "JemBob", lastName = "Coot"},
            ...
            //foreach (Employee emp1 in joes)
            //{
            //    Console.WriteLine(Convert.ToString(emp1.Id) + emp1.firstName + emp1.lastName);
            //}
            ...
            foreach (Employee emp1 in bigId)
            {
                Console.WriteLine(Convert.ToString(emp1.Id) + emp1.firstName + emp1.lastName);
            }
            Console.ReadLine();
